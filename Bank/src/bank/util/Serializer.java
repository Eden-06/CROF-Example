...
public class Serializer{
	...
	public void exchangeTransaction(Transaction transaction) {
		...
		crofAccountTarget.setPlayer("Account@"+playerPosition);			
		int playedPosition=crofTargets.size()-1;
		crofAccountTarget.setPlayed("Target@"+playedPosition);
		...
		crofAccountSource.setPlayer("Account@"+playerPosition);			
		int playedPosition=crofSources.size()-1;
		crofAccountSource.setPlayed("Source@"+playedPosition);
	...
	public void exchangeBank(Bank bank) {
		...
		crofPersonCustomer.setPlayer("Person@"+playerPosition);			
		int playedPosition=crofCustomers.size()-1;
		crofPersonCustomer.setPlayed("Customer@"+playedPosition);
		...
		crofCompanyCustomer.setPlayer("Company@"+playerPosition);			
		int playedPosition=crofCustomers.size()-1;
		crofCompanyCustomer.setPlayed("Customer@"+playedPosition);
		...
		crofAccountSavingsAccount.setPlayer("Account@"+playerPosition);			
		int playedPosition=crofSavingsAccounts.size()-1;
		crofAccountSavingsAccount.setPlayed("SavingsAccount@"+playedPosition);
		...
		crofTransactionMoneyTransfer.setPlayer("Transaction@"+playerPosition);			
		int playedPosition=crofMoneyTransfers.size()-1;
		crofTransactionMoneyTransfer.setPlayed("MoneyTransfer@"+playedPosition);
		...
		crofAccountCheckingAccount.setPlayer("Account@"+playerPosition);			
		int playedPosition=crofCheckingAccounts.size()-1;
		crofAccountCheckingAccount.setPlayed("CheckingAccount@"+playedPosition);
		...
		crofPersonConsultant.setPlayer("Person@"+playerPosition);			
		int playedPosition=crofConsultants.size()-1;
		crofPersonConsultant.setPlayed("Consultant@"+playedPosition);
